            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                <?php if($title === 'Akademik'): ?>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e($subTitle === 'Mahasiswa' ? 'active' : ''); ?>" href="#mahasiswa"
                            ...
                            <div class="collapse <?php echo e($subTitle === 'Mahasiswa' ? 'show' : ''); ?>" id="mahasiswa">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <?php if(session('role') == 'rektor'): ?>
                            <li class="nav-item">
                                ...
                                <div class="collapse <?php echo e($subTitle === 'Akreditasi' ? 'show' : ''); ?>" id="akreditasi">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
