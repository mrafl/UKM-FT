...
<?php $__env->startSection('container'); ?>
    <!-- Header -->
    <div class="header pt-5 pb-7 mt-5" style="background-image: url('<?php echo e(template('assets/img/bg.png')); ?>') !important;">
        <div class="container">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="row pt-5">
                            <div class="col-md-6">
                                <div class="card">
                                    <img class="card-img-top" src="<?php echo e(template('assets/img/home/batavia.jpeg')); ?>"
                                        alt="Image placeholder">
                                </div>
                                <div class="card">
                                    <img class="card-img-top" src="<?php echo e(template('assets/img/home/robotic.jpeg')); ?>"
                                        alt="Image placeholder">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card card-lift--hover shadow border-0 d-flex">
                                <div class="card-body mt--5">
                                    ...
                                    <div class="d-flex">
                                        <a href="<?php echo e(route('abouts')); ?>" class="btn btn-primary mx-auto"
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card card-lift--hover shadow border-0">
                                <div class="card-body mt--5">
                                    ...
                                    <div class="d-flex">
                                        <a href="<?php echo e(route('listUKM')); ?>" class="btn btn-success mx-auto"
                                            style="border-radius: 50px;">Lihat Lebih
                                            Lanjut</a>
                                    </div>
                                </div>
...
<?php echo $__env->make('/layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\applications\UKM-FT-v2\resources\views/home.blade.php ENDPATH**/ ?>