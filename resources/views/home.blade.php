                    ...
                    <div class="col-lg-5">
                        <div class="row pt-5">
                            ...
                            <div class="col-md-6 pt-lg-7 pt-5">
                                <div class="card mb-4">
                                    <img class="card-img-top" src="{{ template('assets/img/theme/img-1-1000x900.jpg') }}"
                                         alt="Image placeholder">
                                </div>
                                <div class="card mb-4">
                                    <img class="card-img-top" src="{{ template('assets/img/theme/img-1-1000x900.jpg') }}"
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card card-lift--hover shadow border-0 d-flex">
                                <div class="card-body mt--5">
                                    <img src="{{ template('assets/img/theme/team-1.jpg') }}"
                                         class="rounded-circle img-center img-fluid shadow shadow-lg--hover mt--5"
                                         style="width: 140px;">
                                    <h4 class="h3 text-primary text-uppercase text-center mt-3">Tentang Website UKM
                                        FT</h4>
                            ...
                            <div class="card card-lift--hover shadow border-0">
                                <div class="card-body mt--5">
                                    <img src="{{ template('assets/img/theme/team-1.jpg') }}"
                                         class="rounded-circle img-center img-fluid shadow shadow-lg--hover mt--5"
                                         style="width: 140px;">
                                    <h4 class="h3 text-success text-uppercase text-center mt-3">Macam - Macam UKM
                                        FT</h4>
                            ...
                            <div class="card card-lift--hover shadow border-0">
                                <div class="card-body mt--5">
                                    <img src="{{ template('assets/img/theme/team-1.jpg') }}"
                                         class="rounded-circle img-center img-fluid shadow shadow-lg--hover mt--5"
                                         style="width: 140px;">
                                    <h4 class="h3 text-warning text-uppercase text-center mt-3">Contact Person UKM
                                        FT</h4>
                                    ...
                                    <div class="d-flex">
                                        <a href="" class="btn btn-warning mx-auto" style="border-radius: 50px;">Lihat
                                            Lebih
                                            Lanjut</a>
                                    </div>
                                </div>
